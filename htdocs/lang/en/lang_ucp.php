...
'need_cookie_yum_yum'   => "* Note, these functions use cookies",
...
'av_t_url'     => "URL Location",
'av_t_gallery' => "Gallery Avatar",
...
'pph_upload'   => "<strong>OR</strong> upload a new image from your computer",
'pph_url'      => "Enter a URL to an online photo image",
'pph_submit'   => "Update Photo",
'pph_remove'   => "Remove Photo",
'pph_max'      => "All photos must be no larger than %s kB and no bigger than %s pixels by %s pixels.",
...
'ras_text'     => "<b>Confirm security code</b><br>To ensure your account safety, please enter the 6 digit code shown above in image format.<br>Note: Only numbers are allowed, a '0' is a numerical zero, not the alphabetical 'O'.",
...
'ft_posts' => "Replies",
'ft_topics' => "Topics",
'ft_unsub'  => "Unsubscribe",
'ft_newpost'  => "Start New Topic",
'ft_last_post' => "Last Post",

'ft_unsub_all' => "Unsubscribe from all forums",
...
'auto_track'      => "<b>Enable 'Email Notification' by default?</b><br>Enabling this option will automatically subscribe you to any topic you start or reply to.",
...
'dst_box' => "<b>Is daylight savings time in effect?</b><br>(If you have selected the correct time zone and the clock appears an hour out, check or uncheck box to suit)",
...
'mess_contact' => "PM Buddies/Block List",
'mess_folders' => "Edit Storage Folders",

'mess_inbox'   => "Inbox",
'mess_sent'    => "Sent items",
...
'm_contact_info' => "Edit Profile info",
...
'm_skin_lang' => "Skin and Languages",
...
'cp_skin_preview'  => "Preview this skin",
...
'month9'                    =>  "September",
'settings_lang_txt'         =>  "Please select a language for the board interface",
'settings_hour'             =>  "Hours",
'edit_profile'              =>  "Edit your profile",
'messenger_url'             =>  "Go to your messenger",
'no'                    =>  "No",
'settings_time_txt'         =>  "<b>You may adjust the base time zone</b><br>The time (including your current adjustment) is:",
...
'pm_reminder'               =>  "<b>Send a confirmation email when I receive a new private message</b><br>Enabling this option will send an email confirmation of any new private messages sent to you.",
...
'settings_skin_txt'         =>  "You may choose a 'skin' to use.<br>This will change the way the board looks",
...
'daily_average'             =>  "Average number of posts per day",
...
'boardlay_changed'  => "Your Board layout is changed now",
'm_board_lay'       => "Board Layout",
'boardlay_title'    => "Board Layout",
...
'm_delete_warning'      => "Warning",
'm_delete_finished'         => "Deleting finished.",
'who_answered'          => "I wish a link with answered to the topic users",
'want_list'             => "Show drop-down forum list at the end of forums and topics ?",
'want_search'           => "Show text box at the top of topics for quick search in the forum ?",
'want_highlight'        => "Highlight the text of first post in the topic within moving mouse on it?",
'close_category'        => "Show forum minimized if there is not any new messages in it's subforums?",
'use_highlight'         => "Use syntax highlight",
'show_history'          => "Show topic messages within 'full' answer?",
'show_filter'           => "Use filters?",
'syntax_code_highlight_settings'        => "Code highlight settings",
'syntax_client'         => "Client Browser Highlight (Java Script)",
'syntax_server'         => "Server Highlight (PHP)",
'syntax_none'           => "Do not use highlight",
'syntax_prism-coy'      => "Prism theme COY (JS)",
'syntax_prism-twilight' => "Prism theme Twilight (JS)",
'syntax_lines_count'    => 'Max number of code lines to display (0 = disable collapsing by default)',
'syntax_show_controls'  => "Show listing control buttons",
'syntax_show_controls_auto'  => "On mouse hover",
'syntax_use_wrap'       => "Use word wrap by default",
'syntax_use_line_numbering' => "Use line numbering by default",
...
$lang['settings_smile']  = "Choose smile skin";
$lang['settings_smile_txt']  = "Please indicate set of smiles that will be used for you";
$lang['cp_smile_preview']  = "Preview this skin";
$lang['text_smile'] = "Text smiles";
$lang['m_title']  = "<b>Your login (Nick)</b> (enter here <b>new</b> login, only if you want to change it)";
$lang['show_new']  = "Show only new topics?";
$lang['no_mail']  = "You cannot work with emails and topic tracker. Reason: \"%s\". Contact with administrator to resolve problem.";

$lang['your_friends']  = "My friends";
$lang['your_enemies']  = "My enemies";
$lang['post_wrap_size_title']  = "Set the maximum length of unwrapped post (in characters). If the post length exceed this value, the post will be wrapped. (Leave empty for not use the autowrapping feature.)";
