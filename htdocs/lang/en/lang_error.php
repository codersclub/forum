...
// Poll Additions
'poll_error_least' => "You must pick at least <#EXTRA#> choices.",
...
'no_integ'  => "Sorry, this member doesn't have a Jabber profile at present.",
...
'search_word_short' => "One or all of your search keywords were below <#EXTRA#> characters or you are searched for words which are not allowed, such as 'html', 'img', etc, please go back and increase the length of these search keywords or choose different keywords.",

'no_name_search_results' => "The member name you chose to filter by cannot be found, please go back and try again.",


'split_not_enough' => "You must choose at least one post to split!",
...
'no_yahoo'		=>	"This member does not have a valid Skype Name",
...
'no_view_forum_always' => "You do not have permission to view this forum!",

'no_view_forum' => "You temporarily do not have permission to view this forum! The suspension is due to end on <#EXTRA#>.",
...
'wrong_pass'					=>	"Sorry, that was the incorrect password for this member account.",
...
'invalid_ext'					=>	"You are not allowed to use that image extension on this board. A valid format is: https://www.domain.com/picture.gif, an invalid format is: https://www.domain.com/picture.one.gif",
...
'no_action'					=>	"Please don't adjust the generated URLs. If you came here in error, please go back and try again <#EXTRA#>",
...
'no_usepm_member'					=>	"This message can not be sent because the recipient does not have permission to use the personal messenger.",
...
'poll_add_vote'					=>	"Vote!",
'you_are_banned'					=>	"Sorry, you are not permitted to use this board <#EXTRA#>",
...
'openid_exists'					=>	"That OpenID cannot be used as it is already in our records",
'openid_not_valid'					=>	"That OpenID is not valid",
...
'fav_guest' 					=> 	"Sorry but you must be logged in to use this feature.",
'no_msg_checked' 					=> 	"No message checked.",
'too_many_msg_checked'  				=> 	"Too many messages checked.",
'any_error'					=> 	"<#EXTRA#>",
'wrong_member_name'				=> 	"You cannot use such membername.",
'rus_en_user_name'				=> 	"Membername contains mixing russian and english letters.",
'too_many_favs'  					=> 	"You have too many bookmarks. Maximum number is <#EXTRA#>.",
'no_mail' 					=> 	"You cannot work with e-mail. Reason: \"<#EXTRA#>\". Please contact with administrator to resolve problem.",
