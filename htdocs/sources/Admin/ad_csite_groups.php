...
echo $sql."<br>";
                ...
                } else
                {
                        ...
                        $DB->query("INSERT INTO ibf_groups
                                        (" .$rstring['FIELD_NAMES']. ")
                                    VALUES
...
// Song * permit reply to old topics, 15.03.05
                ...
                $ADMIN->html .= $SKIN->add_td_row( array( "<b>How many days ago users of this group can reply to topics?</b><br>(Leave blank to make without limits)",
...
// Song * permit reply to old topics, 15.03.05
                ...
                $ADMIN->html .= $SKIN->add_td_row( array( "<b>Can use signature?" ,
                                                                                                  $SKIN->form_yes_no("g_use_signature", $group['g_use_signature'] )
                                                                             )      );

                $ADMIN->html .= $SKIN->add_td_row( array( "<b>Avatar file name for this group?" ,
                ...
                $ADMIN->html .= $SKIN->add_td_row( array( "<b>Can change status of own topics ?</b><br>(decied-undecided)</b>" ,
                ...
                $ADMIN->html .= $SKIN->add_td_row( array( "<b>Can delayed delete own posts?" ,
...
//+-------------------------------
        ...
        function main_screen()
        {
                ...
                $DB->query("SELECT ibf_groups.g_id, ibf_groups.g_access_cp,
