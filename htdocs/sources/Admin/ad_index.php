...
class index_page {
	...
	function index_page() {
		...
		$ADMIN->html .= $SKIN->add_td_row( array( "Block email address:",
		...
		$ADMIN->html .= $SKIN->add_td_row( array( "Unblock email address:",
		...
		$ADMIN->html .= $SKIN->add_td_row( array( "Delete members with email address:",
		...
		$DB->query("SELECT MEMBER_NAME, LOCATION, LOG_IN_TIME, RUNNING_TIME, IP_ADDRESS FROM ibf_admin_sessions WHERE RUNNING_TIME > $t_time and ip_address <> ''");
