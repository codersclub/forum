    ...
    function save_channel()
    {
        ...
        */
        ...
        if ($IN['id']) {
            /* Channels
                   id           int(11)         оЕФ     0
                 descr      varchar(32)         оЕФ
                 channel_url    varchar(255)        оЕФ
                 source_id      int(11)         оЕФ     0
                 forum_id   int(11)         оЕФ     0
                 posting_type   set('SHORT', 'FULL')    оЕФ     SHORT
                 user_id    int(11)         оЕФ     0
                 user_name      varchar(32)         оЕФ
                 url_handler    varchar(32)         оЕФ
                 body_handler   varchar(32)         оЕФ
                 is_active      tinyint(1)      оЕФ 0
            */
