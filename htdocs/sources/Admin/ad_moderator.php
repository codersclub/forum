...
class ad_mod {
	...
	function mod_form( $type='add' ) {
		...
		$ADMIN->html .= $SKIN->add_td_row( array( "<b>Can hide topics?</b>" ,
												  $SKIN->form_yes_no("hide_topic", $mod['hide_topic'] )
									     )      );

		$ADMIN->html .= $SKIN->add_td_row( array( "<b>Can attach links?</b>" ,
												  $SKIN->form_yes_no("can_attach", $mod['can_attach'] )
									     )      );

		$ADMIN->html .= $SKIN->add_td_row( array( "<b>Can pin posts?</b>" ,
												  $SKIN->form_yes_no("can_pin_post", $mod['can_pin_post'] )
									     )      );

		$ADMIN->html .= $SKIN->add_td_row( array( "<b>Can edit forum rules?</b>" ,
												  $SKIN->form_yes_no("rules_edit", $mod['rules_edit'] )
									     )      );

		$ADMIN->html .= $SKIN->add_td_row( array( "<b>Can copy posts to FAQ?</b>" ,
												  $SKIN->form_yes_no("add_to_faq", $mod['add_to_faq'] )
									     )      );
		$ADMIN->html .= $SKIN->add_td_row( array( "<b>Can mirror topics?</b>" ,
