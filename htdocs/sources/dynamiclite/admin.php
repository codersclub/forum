...
define( 'ROOT_PATH', "/home/eebc/eebc_core/" );
...
require ROOT_PATH."sources/dynamiclite/d_admin.php";
require ROOT_PATH."sources/dynamiclite/navigation.php";
require ROOT_PATH."sources/dynamiclite/d_bann_exchange.php";
require ROOT_PATH."sources/dynamiclite/d_reg_form.php";
require ROOT_PATH."sources/dynamiclite/users.php";

$navigation = new navigation;
$d_admin = new d_admin();
$BAN = new banner_exchange;
$RF = new reg_form;
//--------------------------------
...
//---------------------------------------
//GET user's information (moderator etc)
//---------------------------------------
...
//--------------------------------
  ...
  require ROOT_PATH."sources/dynamiclite/csite2.php";
