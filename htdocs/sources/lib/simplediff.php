...
class simpleDiff
{
     ...
     */
    public static function diff($old, $new, $return_as_array = false)
    {
        /**
     ...
     */
    public static function patch($original, $patch, $return_as_array = false)
    {
        $new = array();
     ...
     */
    public static function diff_to_array($diff = false, $old, $new = false, $show_context = true)
    {
     ...
     */
    public static function wdiff($old, $new, $union = ' ')
    {
