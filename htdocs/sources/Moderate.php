...
class Moderate
{
	...
	function split_start()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['st_top'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
	...
	function merge_start()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['mt_top'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);

		$this->output .= View::Make("mod.mod_exp", ['words' => $ibforums->lang['mt_explain']]);

		$this->output .= View::Make("mod.merge_body", ['title' => $this->topic['title'],'desc' => $this->topic['description']]);
	...
	function unsubscribe_all_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['ts_title'] . " &gt; " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
	...
	function poll_delete_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['pd_top'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
	...
	function poll_edit_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['pe_top'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
		...
		$this->output .= View::Make("mod.poll_select_form", ['poll_question' => $poll_data['poll_question'],'life' => $days_left]);

		// Song * multiple choices

		$this->output .= View::Make("mod.poll_select_form_additions_multi", ['min' => $poll_data['multi_poll_min'],'max' => $poll_data['multi_poll_max'],'checked' => $poll_data['is_multi_poll']]);
		$this->output .= View::Make("mod.poll_select_form_additions_weighted", ['places' => $poll_data['weighted_poll_places'],'checked' => $poll_data['is_weighted_poll']]);
	...
	function move_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['top_move'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
	...
	function mirror_topic_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['top_mirror'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
...
//		}
	...
	function delete_mirror_topic_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['top_delete_mirror'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
		$this->output .= View::Make("mod.mod_exp", ['words' => $ibforums->lang['delete_mirror_exp']]);
		$this->output .= View::Make("mod.delete_mirror_form", ['forums' => $forums,'forum_name' => $this->forum['name']]);
	...
	function attach_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['top_attach'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
		$this->output .= View::Make("mod.mod_exp", ['words' => $ibforums->lang['attach_exp']]);
		$jump_html = $this->get_attached_links();
		$this->output .= View::Make("mod.attach_form1", ['comment' => $ibforums->lang['attach_edit'],'jhtml' => $jump_html,'topic_name' => $this->topic['title']]);
		...
		$this->output .= View::Make("mod.attach_form1", ['comment' => $ibforums->lang['data_edit'],'jhtml' => $data_links,'topic_name' => $this->topic['title']]);
		$this->output .= $this->html_start_form(array(
		                                             1 => array('CODE', '81'),
		                                             2 => array('tid', $this->topic['tid']),
		                                             3 => array('auth_key', $ibforums->input['auth_key']),
	...
	function delete_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['top_delete'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
	...
	function edit_form()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['top_edit'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
		$this->output .= View::Make("mod.mod_exp", ['words' => $ibforums->lang['edit_topic']]);
		$this->output .= View::Make("mod.topictitle_fields", ['title' => $this->topic['title'],'desc' => $this->topic['description']]);
	...
	function start_deleting()
	{
		...
		$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['deleting_postz'] . ' "' . $this->topic['title'] . '"']);
	...
	function add_to_faq()
	{
		...
		if (count($faq))
		{
			$this->output .= View::Make("mod.table_top", ['posting_title' => $ibforums->lang['top_copy'] . " " . $this->forum['name'] . " &gt; " . $this->topic['title']]);
