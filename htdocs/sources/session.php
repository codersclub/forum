		...
		if ($member_id != 0)
		{
			...
			if ($stmt->rowCount())
			{
				...
				if ($this->member['id'])
				{
					...
					{
						$this->member['yesterday'] = '�����';
						$this->member['today']     = '�������';

						if ($this->member['disable_mail'] and !$this->member['disable_mail_reason'])
						{
							$this->member['disable_mail_reason'] = "(��� ����������)";
						}
					}
					...
					if (!$this->member['is_mod'])
					{
						...
						if ($this->member['mgroup'] != $ibforums->vars['ban_group'])
						{
							...
							if ($stmt->rowCount())
							{
								...
								{
									// vot: BAD MESSAGE!
									$mes .= "[color=green]�� ������� ���������� � ������ ����������.[/color]";
								} else
								{
									// vot: BAD MESSAGE!
									$mes .= "[color=red]�� ���������� � ������ ���������� ������� ������ " . $level . ".[/color]";
								}
					...
					)
					{
						...
						$mes = "������������, %s!\n";
						$mes .= "�� �� �������� ����� �� ����������.RU (http://forum.sources.ru) ��� � ������� 150-�� ����.\n";
						$mes .= "�� �������� ������ ������ ������� ���������, ���� �������� �� ���� �� �������� ����� � ������� 6 �������, ";
						$mes .= "����������� ��� ����� ���������. �������, ���� �� �� ������ �� ��� ����� ��� � ������� ������, ";
						$mes .= "��� ������� ����� ����� ��� ���������� ��������������.\n";
						$mes .= "���� �� ������ ����� ��������� ��� ����� � ������������� ���������� ��� �������� ������, ������ ������� ";
