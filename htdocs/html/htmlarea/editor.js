...
this.btnList = {
    ...
    "insertimage":    ['InsertImage',          'Вставить картинку',  'editor_action(this.id)',  'ed_image.gif'],
...
function editor_action(button_id, params) {
...
//      editdoc.txtUrl = params;
      editdoc.execCommand(cmdID,false,params);
    }

    // insert image
    else if (cmdID.toLowerCase() == 'insertimage'){

      editdoc.imgUrl = params;
