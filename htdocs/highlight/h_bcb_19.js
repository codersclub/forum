window['h_bcb']=[
 ...
 [
    /^(asm|break|case|catch|continue|default|delete|do|dynamic_cast|else|false|for|goto|if|namespace|new|private|protected|public|reinterpret_cast|return|sizeof|static_cast|switch|this|throw|true|try|using|virtual|while)\b/,
    ['',0],
    ['<b>',3],
    ['</b>',0]
 ],
