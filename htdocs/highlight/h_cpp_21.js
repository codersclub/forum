window['h_cpp']=[
 ...
 [
    /^(new|delete|this|return|goto|if|else|case|default|switch|break|continue|while|do|for|try|catch|throw|sizeof|true|false|namespace|using|dynamic_cast|static_cast|reinterpret_cast|public|protected|private|class|asm|_asm|__asm|template|virtual|__try|__catch|__except|__finaly|operator|friend)\b/,
    ['',0],
    ['<span style=\'color:blue\'>',3],
    ['</span>',0]
 ],
