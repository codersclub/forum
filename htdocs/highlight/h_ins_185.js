window['h_ins']=[
 ...
 [
    /^(var|function|begin|end|procedure|with|do|if|then|else|true|false|for|to|downto|repeat|until|continue|case|of|not)\b/i,
    ['',0],
