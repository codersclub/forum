window['h_ins']=[
 ...
 [
    /^(external|var|function|begin|end|procedure|with|do|if|then|else|true|false|for|to|downto|repeat|until|continue|case|of|not|try|finally|except)\b/i,
    ['',0],
