...
<br>
	<div class="tableborder">
	  ...
	  <tr> 
		<td align="center" class='titlemedium'><img src="{$ibforums->vars['img_url']}/spacer.gif" alt="" width="2%" height="1"></td>
		<th align='left' width="98%" class='titlemedium'>{$ibforums->lang['cat_name']}</th>
	  </tr>
...
<b>{$ibforums->vars['board_name']} {$ibforums->lang['newslink']} <a href='{$ibforums->base_url}showtopic=$tid&view=getnewpost'>$title</a></b><br>
...
<tr> 
          ...
          <td class="row4"><b><a href="{$ibforums->base_url}showforum={$info['id']}">{$info['name']}</a></b><br><span class='desc'>{$info['description']}<br></span></td>
        </tr>
