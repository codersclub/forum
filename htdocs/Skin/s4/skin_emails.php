...
<div class='tableborder'>
  ...
  <table cellpadding='4' cellspacing='1' border='0' width='100%'>
   ...
   <td class='row1' width='80%'><textarea cols='60' rows='12' wrap='soft' name='message' class='textinput'
       onKeyPress='if (event.keyCode==10 || ((event.metaKey || event.ctrlKey) && event.keyCode==13))
	this.form.go.click()'></textarea>
   </td>
   </tr>
  </table>
  <div align='center' class='pformstrip'><input type="submit" name=go value="{$ibforums->lang['report_submit']}" class='forminput'></div>
 </div>
</form>
EOF;
}
