...
function postbox_buttons($data, $syntax_select = "", $mod_buttons = "") {
global $ibforums;
return <<<EOF
...
<br>
   ...
   <tr>
     <td class='pformleft' align='center'>
	   <!--SMILIE TABLE-->
	   <br><div class='desc'><strong>&middot; <a href='javascript:bbc_pop()'>{$ibforums->lang['bbc_help']}</a> &middot;</strong></div>
     </td>
	...
	this.form.submit.click()' tabindex='3' style='width:99%' class='textinput'>$data</textarea></td>
   </tr>
   <tr>
...
<tr>
 ...
 <tr>
   ...
   <td class='pformright'>
	   ...
	   <input type='button' accesskey='с' value=' С ' onclick='simpletag("C")' class='codebuttons' name='C' title='Center'">
...
foreach($files as $attach) {
	$res .=  <<<EOF
		<table cellpadding='4' cellspacing='0' width='100%' border='0'>
            <tr>
             <td><input type='radio' name='editupload[{$attach->attachId()}]' value='keep' checked></td>
             <td width='100%'><b>{$ibforums->lang['eu_keep']}</b> ( {$attach->filename()} )</td>
            </tr>
            <tr>
             <td><input type='radio' name='editupload[{$attach->attachId()}]' value='delete'></td>
             <td width='100%'><b>{$ibforums->lang['eu_delete']}</b></td>
            </tr>
            <tr>
             <td valign='middle'><input type='radio' name='editupload[{$attach->attachId()}]' value='new'></td>
             <td><b>{$ibforums->lang['eu_new']}</b><br><input class='textinput' type='file' size='30' name='FILE_UPLOAD[]' onclick='document.REPLIER["editupload[{$attach->attachId()}]"][2].checked=true;'></td>
            </tr>
           </table>
EOF;
}
...
$res .= <<<EOF
		    ...
		    <input class='textinput' type='file' size='30' name='FILE_UPLOAD[]' id="first_upload_element">
		    </div>
...
<tr>
  ...
  <td class='pformright'><input type='text' size='40' maxlength='128' name='TopicTitle' value='{$data[TITLE]}' tabindex='1' class='forminput'></td>
</tr>
<tr>
   <td class='pformleft'>{$ibforums->lang['topic_desc']}</td>
   <td class='pformright'><input type='text' size='40' maxlength='250' name='TopicDesc' value='{$data[DESC]}' tabindex='2' class='forminput'></td>
</tr>
...
<tr>
   <td class='pformstrip' colspan='3'>{$ibforums->lang['rr_options']}</td>
  </tr>
  <tr>
    <td class='pformleft'>{$ibforums->lang['rrr_options']}</td>
    <td class='pformright' colspan='2'><input type='checkbox' name='club_only' value=1 $checked class='forminput'>&nbsp;{$ibforums->lang['rrr_club_options']}</td>
  </tr>
