 ...
 <td id="ucpmenu" valign="top">
    <div class='maintitle'><span style='color:black'>{$ibforums->lang['tt_menu']}</span></div>
	 ...
	 &middot; <a href='{$base_url}act=UserCP&amp;CODE=08'>{$ibforums->lang['m_email_change']}</a><br>
         ...
         &middot; <a href='{$base_url}act=UserCP&amp;CODE=15'>{$ibforums->lang['m_board_lay']}</a>
	 </p>
 </td>
...
<textarea cols='60' rows='12' name='Post' tabindex='3' class='textinput'
	...
	this.form.go.click()'>$t_sig</textarea>
<br>(<a href='javascript:CheckLength()'>{$ibforums->lang['check_length']}</a>)</p></div>
...
function boardlay_between($data) {
global $ibforums;
return <<<EOF
		<tr>
			<td class='{$data['css']}'><input type='checkbox' name='{$data['qid']}{$data['id']}' value='1' {$data['sh']}></td>
