...
<td class='row1'>
 ...
 <input type='checkbox' name='ip_sub_include' value='1'> {$ibforums->lang['ip_sub_include']}<br>
 <input type='checkbox' name='ip_sub_guests' value='1'> {$ibforums->lang['ip_sub_guests']}
</td>
...
<div class='tableborder'>
 ...
 <tr>
   ...
   <td class='row1'>
	 <select name='ip_select' class='forminput' size=16>{$ip}</select>
   </td>
  </tr>
  </table>
...
<div class='tableborder'>
 ...
 <tr>
  ...
  <td class='row1'><textarea cols='80' rows='20' name='rules_txt' class='forminput'>{$txt}</textarea></td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <div class='pformstrip' align='center'><input type='submit' value='{$ibforums->lang['syntax_edit_submit']}' class='forminput'></div>
</div>
</form>
