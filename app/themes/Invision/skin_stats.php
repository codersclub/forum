...
function one_leader_strip( $name ) {
global $ibforums;
return <<<EOF
<div class="tableborder">
 ...
 <table cellpadding='4' cellspacing='1' width="100%">
  <tr>
    <td width='30' align='center' class='pformstrip' valign='middle'>{$ibforums->lang['mod_number']}</td>
    <td align='center' class='pformstrip' valign='middle'>{$ibforums->lang['leader_forums']}</td>
    <td width='100' align='center' class='pformstrip' valign='middle'>{$ibforums->lang['mod_posts']}</td>
	</tr>
EOF;
}


function one_leader($number, $forum, $posts_count) {
global $ibforums;
return <<<EOF
  <tr>
   <td align='center' class='row3' valign='middle'><b>$number</b></td>
	 <td align='left' class='row1' valign='middle'>$forum</td>
	 <td align='center' class='row1' valign='middle'>$posts_count</td>
  </tr>
EOF;
}
